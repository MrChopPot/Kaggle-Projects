...
```{r}
pred <- predict(gbm_ensemble, dmy_data[-index,], type = "raw")
...
```{r}
pred_c <- predict(gbm_ensemble_c, dmy_data_c[-index_c,], type = "raw")
...
```{r}
pred_d <- predict(gbm_ensemble_d, dmy_data_d[-index_d,], type = "raw")
